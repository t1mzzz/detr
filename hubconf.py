...
def _make_detr(backbone_name: str, dilation=False, num_classes=5, mask=False):
    hidden_dim = 256
...
def detr_resnet50(pretrained=False, num_classes=5, return_postprocessor=False):
    """
...
def detr_resnet50_dc5(pretrained=False, num_classes=5, return_postprocessor=False):
    """
...
def detr_resnet101(pretrained=False, num_classes=5, return_postprocessor=False):
    """
...
def detr_resnet101_dc5(pretrained=False, num_classes=5, return_postprocessor=False):
    """
    DETR-DC5 R101 with 6 encoder and 6 decoder layers.
